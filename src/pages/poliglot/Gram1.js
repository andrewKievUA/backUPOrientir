...
const Gram1 = () => {
  ...
  if (questionNumber === ar.length - 1) { changeTematic() }
  ...
  return (
    ...
    <>
      ...
      <Button size="small" color="inherit" variant="outlined" onClick={() => { setStudy(!study) }}> Обучение</Button>

      {correctAnswer + "/" + wrongAnswer.length + "/" + Math.round((correctAnswer / wrongAnswer.length + 1)) + "%"}
